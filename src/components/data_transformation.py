...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        try:
            ...
            cat_pipeline = Pipeline(steps = [("imputer", SimpleImputer(strategy = "most_frequent")), ("One Hot Encoder", OneHotEncoder())])
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try : 
            ...
            logging.info("Applying preprocessing object on training and testing datatframe")
